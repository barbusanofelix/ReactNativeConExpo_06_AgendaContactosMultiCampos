...
Guardamos los cambios y hacemos el test real en el movil:

* Abrimos el formulario para editar de cualquier contacto.
* Abrimos el teclado, tocando por ejemplo el campo de Empresa. Ahora debemos hacer Scroll en la pantalla y quedar a la vista el campo que estemos editando ( no oculto por el teclado). Intentamos arrastrar la pantalla con tu dedo hacia arriba. ¿Notas que ahora la pantalla se desliza como si fuera una página web larga, permitiéndote bajar cómodamente hasta el fondo?
